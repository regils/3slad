...
class Decoder(srd.Decoder):
    ...
    def decode(self):
        ...
        while True:
            pins = self.wait([{Pin.SDO1: self.passive_signal, Pin.SDO2: self.passive_signal}, 
                              {Pin.SDO1: self.active_signal, Pin.SDO2: self.passive_signal}, 
                              {Pin.SDO1: self.passive_signal, Pin.SDO2: self.active_signal}, 
                              {Pin.SDO1: self.active_signal, Pin.SDO2: self.active_signal}])
